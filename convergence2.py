...
# def solve_poisson(mesh, markers, vsources, Q, rho, order):
...
#     # objects = [DirichletBC(V, Constant(1), bnd, 2)]
#     objects = [ObjectBC(V, bnd, 2+i) for i in range(len(markers)-1)]
...
for res in resolutions:
    ...
    for order in orders:
        ...
        # bcs = [DirichletBC(V, Constant(i), bnd, i+1) for i in range(n_bnd)]
